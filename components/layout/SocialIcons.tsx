...
export function XIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden {...props}>
      <path d="M18.244 2H21l-6.52 7.45L22 22h-6.273l-4.91-6.41L5.1 22H2.345l6.972-7.967L2 2h6.4l4.43 5.86L18.244 2Zm-2.197 18.222h1.7L7.05 3.67H5.226l10.821 16.553Z" />
    </svg>
  );
}
